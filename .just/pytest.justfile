...
pytest-coverage *args:
    uv run pytest tests --color=yes --cov=src --cov-fail-under=100 --cov-report html:var/coverage/html --cov-report xml:var/coverage/pytest-cobertura.xml --cov-report term-missing --junit-xml='var/coverage/pytest-junit.xml' {{args}}
